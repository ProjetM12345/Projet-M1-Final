...
var heightRatio =0.005;
canvas.height = document.body.clientWidth * heightRatio;*/
function onWindowResize() {
    contenedor=document.getElementById("canvas-holder1");
    camera.aspect = contenedor.clientWidth / contenedor.clientHeight;
    camera.updateProjectionMatrix();
    renderer.setSize(contenedor.clientWidth, contenedor.clientWidth*0.55);
...
function init() {
    try {
        ...
        document.getElementById("canvas-holder1").innerHTML="<p><b>Sorry, an error occurred:<br>" +
            e + "</b></p>";
        return;
    }
